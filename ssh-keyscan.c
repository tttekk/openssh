...
#else
#define KT_MAYO_2 (0)
#define KT_RSA3072_MAYO_2 (0)
#define KT_ECDSA_NISTP256_MAYO_2 (0)
#define KT_MAYO_3 (0)
#define KT_ECDSA_NISTP384_MAYO_3 (0)
#define KT_MAYO_5 (0)
#define KT_ECDSA_NISTP521_MAYO_5 (0)
#endif
...
#ifdef EN_MAYO
#define KT_MAX KT_ECDSA_NISTP521_MAYO_5
#else
#define KT_MAX KT_ECDSA_NISTP521_ML_DSA_87
#endif
...
///// OQS_TEMPLATE_FRAGMENT_ADD_PROPOSAL_SERVER_HOST_KEY_ALGS_START
	...
	case KT_MAYO_2:
	  ...
	  break;
	case KT_MAYO_3:
	  myproposal[PROPOSAL_SERVER_HOST_KEY_ALGS] = "ssh-mayo3";
	  break;
	case KT_MAYO_5:
	...
	case KT_ECDSA_NISTP256_MAYO_2:
	  ...
	  break;
	case KT_ECDSA_NISTP384_MAYO_3:
	  myproposal[PROPOSAL_SERVER_HOST_KEY_ALGS] = "ssh-ecdsa-nistp384-mayo3";
	  break;
...
///// OQS_TEMPLATE_FRAGMENT_ASSIGN_KEX_GEN_CLIENT_START
	...
	c->c_ssh->kex->kex[KEX_KEM_FRODOKEM_640_SHAKE_X25519_SHA256] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_KYBER_512_X25519_SHA256] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_BIKE_L1_X25519_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_BIKE_L3_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_BIKE_L5_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_CLASSIC_MCELIECE_348864_SHA256] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_CLASSIC_MCELIECE_348864_X25519_SHA256] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_CLASSIC_MCELIECE_348864F_SHA256] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_CLASSIC_MCELIECE_348864F_X25519_SHA256] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_HQC_128_X25519_SHA256] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_BIKE_L5_ECDH_NISTP521_SHA512] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_ML_KEM_512_ECDH_NISTP256_SHA256] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_ML_KEM_768_ECDH_NISTP256_SHA256] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_ML_KEM_1024_ECDH_NISTP384_SHA384] = kex_gen_client;
#endif /* OPENSSL_HAS_ECC */
#endif /* WITH_OPENSSL */
